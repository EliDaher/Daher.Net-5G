...
function Navbar({setOpenNav, openNav}){
    return<>
        <div className={`bg-primary h-screen w-60 h-100 absolute top-0 ${openNav ? "left-0" : "-left-64"} transition-all z-40 shadow-lg`}>
            <button className="right-2 absolute p-1 bg-primary" onClick={() => setOpenNav(!openNav)}>
